...
Gem::Specification.new do |spec|
  ...
  spec.metadata["organization"] = "LogicBunch"
  ...
  spec.homepage = "https://github.com/logicbunchhq/ai_guardrails"
  spec.license = "MIT"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/logicbunchhq/ai_guardrails"
  spec.metadata["changelog_uri"] = "https://github.com/logicbunchhq/ai_guardrails/blob/main/CHANGELOG.md"
  spec.metadata["documentation_uri"] = "https://github.com/logicbunchhq/ai_guardrails#readme"
  spec.metadata["rubygems_keywords"] = "AI, Guardrails, Ruby, LLM, JSON, Schema, Auto-correction, Safety"
  ...
  extra_files = %w[README.md CHANGELOG.md LICENSE]
  spec.files += extra_files.select { |f| File.exist?(f) }
